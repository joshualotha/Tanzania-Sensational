                            ...
                            return (
                                ...
                                >
                                    <div className="lux-package-image">
                                        <img src={route?.hero_image || visualsData.trekking.routes.lemosho} alt="Lemosho departure" />
                                    </div>
                                    <div className="lux-package-content">
                                        ...
                                        <div className="lux-package-footer">
                                            <div style={{ display: 'flex', justifyContent: 'space-between', gap: 14, alignItems: 'center' }}>
                                                <Link to={`/booking/departure/${dep.id}`} className="lux-link-arrow">
                                                    Request booking
                                                ...
                                                <Link to={`/trekking/kilimanjaro/lemosho/${dep.id}`} className="lux-link-arrow" style={{ opacity: 0.8 }}>
                                                    View details
                                                </Link>
                                            </div>
                                        </div>
