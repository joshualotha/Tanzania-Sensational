...
const Machame = () => {
    ...
    useEffect(() => {
        ...
        const run = async () => {
            setLoading(true);
            try {
                const res = await trekkingService.getBySlug('machame');
                if (!mounted) return;
                            ...
                            return (
                                ...
                                >
                                    <div className="lux-package-image">
                                        <img src={route?.hero_image || visualsData.trekking.routes.machame} alt="Machame departure" />
                                    </div>
                                    <div className="lux-package-content">
                                        ...
                                        <div className="lux-package-footer">
                                            <div style={{ display: 'flex', justifyContent: 'space-between', gap: 14, alignItems: 'center' }}>
                                                ...
                                                <Link to={`/trekking/kilimanjaro/machame/${dep.id}`} className="lux-link-arrow" style={{ opacity: 0.8 }}>
                                                    View details
                                                </Link>
                                            </div>
                                        </div>
